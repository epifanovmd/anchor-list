...
История вверх, новые сообщения вниз, панель ввода, прилипающие даты.
...
Растёт только вниз, компенсация не нужна.
...
Порог «у конца» настраивается `maintainScrollAtEndThreshold` — тем же, по
которому работает автоприлипание.
